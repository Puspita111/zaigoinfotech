...
<head>
        ...
        <meta charset="utf-8" />
        <title>Sign Up | Zaigo - Admin & Dashboard Template</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta content="Minimal Admin & Dashboard Template" name="description" />
        <meta content="Puspita" name="author" />
        <!-- App favicon -->
                            ...
                            <div class="card-body">
                                <div class="row g-0">
                                        ...
                                        <div class="card auth-card bg-primary h-100 border-0 shadow-none p-sm-3 overflow-hidden mb-0">
                                            <div class="card-body p-4 d-flex justify-content-between flex-column">
                                                <div class="auth-image mb-3">
                                                    <img src="https://www.zaigoinfotech.com/wp-content/uploads/2022/05/cropped-logo.webp" alt="" height="60x" />
                                                ...
                                                <div class="text-center text-white-75">
                                                    <p class="mb-0">&copy;
                                                        <script>document.write(new Date().getFullYear())</script> Zaigo. Crafted with <i class="mdi mdi-heart text-danger"></i> by Puspita
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card mb-0 border-0 shadow-none">
                                            <div class="card-body px-0 p-sm-5 m-lg-4">
                                                <div class="text-center mt-2">
                                                    <h5 class="text-primary fs-20">Create an account !</h5>
                                                    <p class="text-muted">Sign Up in to continue to Zaigo.</p>
                                                </div>
                                                @error('invalid')
                                    ...
                                    @enderror
                                                      ...
                                                      <input type="text" class="form-control" id="username" name="email" value="{{old('email')}}" placeholder="Enter your email">
                                                      @error('email')
                                  <span class="validation">{{ $message }}</span>
                              @enderror
                                                  </div>
